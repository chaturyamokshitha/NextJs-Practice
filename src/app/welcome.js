    ...
    return (
        <div>
            <div className="flex text-black justify-between">
                <div>
                    ...
                    />
                    <h2 className="text-md font-bold ml-24 mt-14 mb-4">
                        DIGITAL MARKETING AGENCY
                    </h2>
                    <h1 className="text-5xl ml-24 font-bold mb-2">
            ...
            <div className="mt-40 px-4">
                ...
                <div className="flex mt-40 space-x-20">
                    ...
                    <div className="text-black lg:w-1/2 mt-14 ml-28">
                        <h2 className="text-2xl font-bold mb-4">Creating Business Growth</h2>
            ...
            <div className="mt-40 text-black animate-fadeIn">
                <h1 className="text-4xl font-bold text-center">The Installa Solutions</h1>
                ...
                <div className="flex flex-col lg:flex-row items-start mt-20 px-6 lg:px-20">
                    ...
                    <div className="text-md max-w-2xl mb-10 lg:mb-0">
                        <h2 className="text-2xl font-semibold mb-6">Tailor-Made Marketing Strategies</h2>
                        <p className="mb-4">
            ...
            {"4 grid cells"}
            <div className="grid grid-cols-2 gap-x-10 gap-y-20 m-20">
                <div className="bg-[#F8CBCE] text-black flex items-center flex-col rounded-4xl p-10  w-[590px] max-w-full">
                    <Image
                        ...
                        className=""
                    />
                    <h1 className="text-xl font-bold ">Clear Concepts</h1>
                    <p className="text-md ">In terms of our strategic business planning, we possess a clear view on how to structure our marketing campaigns, as we heavily rely on in-depth research and analysis.</p>
                </div>
                <div className="bg-[#F8CBCE] text-black flex items-center flex-col rounded-4xl p-10 w-[590px] max-w-full">
                    <Image
                        ...
                        className=""
                    />
                    <h1 className="text-xl font-bold">Innovative Technology</h1>
                    <p className="text-md ">We utilize a unique approach when it comes to keyword research, grouping, as well as discovery. We conduct keyword analysis, considering the intent of searchers and use that to your advantage.</p>
                </div>
                <div className="bg-[#F8CBCE] text-black flex items-center flex-col rounded-4xl p-10 w-[590px] max-w-full">
                    <Image
                        src="/m.svg"
                        ...
                        className=""
                    />
                    <h1 className="text-xl font-bold">In-depth Analysis</h1>
                    <p className="text-md ">We perform extensive research in order to improve or adjust targeting techniques, making sure we translate those efforts throughout all advertising platforms your business makes use of.</p>
                </div>
                <div className="bg-[#F8CBCE] text-black flex items-center flex-col rounded-4xl p-10 w-[590px] max-w-full">
                    <Image
                        ...
                        className=""
                    />
                    <h1 className="text-xl font-bold">Performance Enhancement</h1>
                    <p className="text-md ">We help you breakdown your campaign initiatives and narrow down your targeting towards the people who actively clicking on your ads – we provide filtering by gender, age, placement, and device.</p>
                </div>
            </div>
        <div className="mt-20 text-black">
                <Image
                    ...
                    className="relative left-[405px] top-10"
                />
                <h1 className="text-center text-4xl font-bold">Get Your Campaign Performance on<br></br>
                    Another Level!</h1>
                <h2 className="text-center ">Further develop your successful online presence and scale up your business.</h2>
