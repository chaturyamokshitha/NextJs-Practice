    ...
    return (
        <div>
            ...
            <Image
                ...
                width={150}
                height={150}
                className="absolute top-18 w-[100px] md:w-[150px]"
            />
            <Image
                src="/arrows.svg"
                alt="arrows"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-10 mt-20 relative">
                <Image
                    src="/semi-circle.svg"
                    alt="semi-circle"
                    width={180}
                    height={150}
                    className="absolute left-0 md:top-[00px] hidden md:block"
                />
                ...
                {/* Desktop Image + Text in one grid item */}
                ...
                <div className="md:mt-0 md:ml-20 ml-4 flex flex-col justify-center">
                    ...
                    <div className="flex justify-end items-end"><button className="text-md text-[#FE4E5A] font-semibold border-1 border-[#FE4E5A] px-11 py-2 rounded-4xl hover:bg-[#FE4E5A] hover:text-white">
                        Get In Touch
                    </button></div>
                </div>
            </div>
